...
#define RHO 1.68e-8 // ohms * meters
#define AREA 3.26e-7 // converted to meters squared to match RHO
#define RESISTANCE(length) (RHO * (length) / AREA)
...
// Amps from the battery are limitless, so we'll always have a steady supply of 1.5 volts
//   from the battery. However wher
